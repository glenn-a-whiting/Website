...
<html>
    <head>
        ...
        <link rel="stylesheet" media="(min-device-width:300px)" href="{{asset('css/Jacks_Pancakes/astyle.css')}}">
        <link rel="stylesheet" media="(max-device-width:299px)" href="{{asset('css/Jacks_Pancakes/amobile.css')}}">
    </head>
    <body>
        <div class ="banner">
            <div class="titleContainer">
                <div class="title">
                    ...
                    <div class="titleImage">
                        <img src="{{asset('css/Jacks_Pancakes/pancakes.png')}}"/>
                    </div>
                    <div class="titleSpan">
                    Pancakes
                    </div>
            ...
            <div class="contentContainer">
                <div class="content" id="homepage">
                    <div class="contentImage">
                        <img src="{{asset('css/Jacks_Pancakes/pancakes.png')}}" height="200px"/>
                    </div>
